...
/**
 * @ORM\Table(name="live_location",
 *     uniqueConstraints={
 *         @ORM\UniqueConstraint(name="uniq_live_location_source", columns={"source_type", "source_id"})
 *     },
 *     indexes={
 *         @ORM\Index(name="idx_live_location_center_recorded_at", columns={"center_id", "recorded_at"}),
 *         @ORM\Index(name="idx_live_location_source_recorded_at", columns={"source_type", "source_id", "recorded_at"})
 *     }
 * )
 * @ORM\Entity
