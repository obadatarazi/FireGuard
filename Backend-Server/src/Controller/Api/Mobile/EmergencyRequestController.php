...
#[Route('/api/mobile/fire-brigade/emergency-requests')]
class EmergencyRequestController extends RestController
{
    ...
    * @return Response
    */
    #[Route('', requirements: ['id' => '\d+'], methods: ['GET'])]
    #[OA\Tag(name: 'Mobile SOS Emergency Request')]
    ...
    */
    #[Route('', methods: ['POST'])]
    #[OA\Tag(name: 'Mobile SOS Emergency Request')]
    #[OA\Response(response: 201, description: 'Returns Created Emergency Request', content: new OA\JsonContent(properties: [
        new OA\Property(property: "success", type: "boolean"),
        new OA\Property(property: 'data', ref: new Model(type: EmergencyRequest::class, groups: ['details']))
    ]))]
    #[OA\RequestBody(
    ...
    public function create(Request $request): Response
    {
        ...
        $this->emergencyRequestService->add($emergencyRequest);
